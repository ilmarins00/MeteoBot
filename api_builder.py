    ...
    hourly_light = [
        {
            ...
            "precip": h.get("precip"),
            "precip_cum": h.get("precip_cum"),
            "cloud": h.get("cloud"),
            "cloud_low": h.get("cloud_low"),
            "cloud_mid": h.get("cloud_mid"),
            "cloud_high": h.get("cloud_high"),
            **{
                f"temperature_{level}": h.get(f"temperature_{level}")
                for level in ("1000hPa", "925hPa", "850hPa", "700hPa",
                              "600hPa", "500hPa", "400hPa", "300hPa")
            },
            "SBCAPE": h.get("SBCAPE", h.get("CAPE")),
            "MUCAPE": h.get("MUCAPE"),
            "CIN": h.get("CIN"),
            "LI": h.get("LI"),
            "shear": h.get("shear"),
            "shear_0_1": h.get("shear_0_1"),
            "shear_0_3": h.get("shear_0_3"),
            "SRH": h.get("SRH"),
            "srh_0_1": h.get("srh_0_1"),
            "PWAT": h.get("PWAT"),
            "DCAPE": h.get("DCAPE"),
            "STP": h.get("STP"),
            "KI": h.get("KI"),
