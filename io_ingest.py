...
def build_nowcast_quarter_hourly(
    ...
    for i, t in enumerate(times):
        ...
        riga = {
            ...
            "cloud":      g("cloud_cover", i, parent.get("cloud")),
            "cloud_low":  g("cloud_cover_low", i, parent.get("cloud_low")),
            "cloud_mid":  g("cloud_cover_mid", i, parent.get("cloud_mid")),
            "cloud_high": g("cloud_cover_high", i, parent.get("cloud_high")),
            ...
            "SRH":        parent.get("SRH"),
            "wmo_code":   g("weather_code", i, parent.get("wmo_code")),
            "alert":      alert,
            "LI":         parent.get("LI"),
